...
public class FincasysEditText extends EditText {

    String customFont;

    public FincasysEditText(Context context) {
        super(context);
    }

    public FincasysEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        style(context, attrs);
    }

    public FincasysEditText(Context context, AttributeSet attrs, int defStyle) {
